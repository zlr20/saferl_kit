...
class SafexpEnvBase:
    ...
    def register(self, name='', config={}):
        # Note: see safety_gym_arm/envs/mujoco.py for an explanation why we're using
        # 'safety_gym_arm.envs.mujoco:Engine' as the entrypoint, instead of
        # 'safety_gym_arm.envs.engine:Engine'.
