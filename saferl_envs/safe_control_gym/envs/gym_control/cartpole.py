...
class CartPole(BenchmarkEnv):
    ...
    def reset(self):
        ...
        self.override_path = self.URDF_PATH #os.path.join(self.output_dir, "pid-{}_id-{}_cartpole.urdf".format(os.getpid(), self.id))
        ...
        #self.planeUid=p.loadURDF("plane.urdf",basePosition=[0,0,1.5],physicsClientId=self.PYB_CLIENT)
