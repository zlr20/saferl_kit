...
DIV_LINE_WIDTH = 50
# python utils/plot_yifan.py comparison_yifan/ --results_dir results/scpo_paper --title pillar1 --reward --cost 
...
def get_datasets(logdir, condition=None):
    ...
    for root, _, files in os.walk(logdir):
        if 'progress.txt' in files:
            ...
            if 'adascale' in condition1:
                condition3 = 'with downsampling'
            else:
                condition3 = 'without downsampling'
