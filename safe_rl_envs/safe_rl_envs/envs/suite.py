...
class SafexpEnvBase:
    ...
    def register(self, name='', config={}):
        # Note: see  safe_rl_envs/envs/mujoco.py for an explanation why we're using
        # ' safe_rl_envs.envs.mujoco:Engine' as the entrypoint, instead of
        # ' safe_rl_envs.envs.engine:Engine'.
        for robot_name, robot_config in self.robot_configs.items():
            ...
            register(id=env_name,
                     entry_point=' safe_rl_envs.envs.mujoco:Engine',
